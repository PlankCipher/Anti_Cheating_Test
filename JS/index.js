...
(function () {
  ...
  document
    .querySelector('#antiCheatingBtn')
    .addEventListener('mouseup', restartCounterForUser);
  document
    .querySelector('#antiCheatingBtn')
    .addEventListener('mouseleave', restartCounterForUser);
  document
    .querySelector('#form')
    .addEventListener('mouseleave', restartCounterForUser);
  ...
  document
    .querySelector('#form')
    .addEventListener('mousemove', mouseMoveInsideFormHandler);
  ...
  function showMsg(
    ...
    document.querySelector('#messageBoxText').innerText = msgTxt
      ? msgTxt
      : document.querySelector('#messageBoxText').innerText;
    ...
    if (latestClosingCallback) {
      document
        .querySelector('#messageBoxCloseIcon')
        .removeEventListener('click', latestClosingCallback);
    }

    latestClosingCallback = closingCallback;
    document
      .querySelector('#messageBoxCloseIcon')
      .addEventListener('click', closingCallback);
  }
  ...
  function restartCounter(prevIntervalId) {
    ...
    let intervalID = setInterval(function () {
      ...
      if (count == 0) {
        showMsg(
          'You can no longer complete this test, you were considered cheating.',
          1,
          void 0,
          false,
        );
  ...
  function stopAllAntiCheatingEventListeners() {
    document
      .querySelector('#antiCheatingBtn')
      .removeEventListener('mouseup', restartCounterForUser);
    document
      .querySelector('#antiCheatingBtn')
      .removeEventListener('mouseleave', restartCounterForUser);
    document
      .querySelector('#form')
      .removeEventListener('mouseleave', restartCounterForUser);
    document
      .querySelector('#form')
      .removeEventListener('mousemove', mouseMoveInsideFormHandler);
  }
